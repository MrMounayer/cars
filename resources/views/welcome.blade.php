    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] antialiased">
        <header class="bg-white/80 dark:bg-[#161615]/80 shadow-sm sticky top-0 z-20">
            <div class="max-w-5xl mx-auto flex items-center justify-between px-6 py-4">
                <span class="font-bold text-2xl text-[#1a237e] dark:text-[#90caf9]">Car Valuation App</span>
        ...
        <main class="max-w-5xl mx-auto px-6 py-12">
            <section class="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
                <div class="flex-1">
                    <h1 class="text-4xl font-extrabold mb-4 text-[#1a237e] dark:text-[#90caf9] leading-tight">
                    ...
                    <ul class="space-y-3 mb-8" id="features">
                        <li class="flex items-center gap-3">
                            <svg class="size-5 text-[#1a237e] dark:text-[#90caf9]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('car-valuation.form') }}"
                       class="inline-block bg-[#1a237e] hover:bg-[#0d1335] text-white font-semibold px-8 py-3 rounded-lg shadow transition-colors text-lg">
                        Get Started
                    </a>
                        <a href="{{ route('vin.form') }}" class="inline-block px-6 py-3 bg-gray-200 text-indigo-700 font-semibold rounded-lg shadow hover:bg-gray-300 transition mb-4">VIN Decoder</a>

                        <a href="{{ route('car-valuation.form') }}" class="inline-block px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg shadow hover:bg-indigo-700 transition mb-4">Start Valuation</a>
                </div>
                <div class="flex-1 flex justify-center">
                    <div class="relative w-full max-w-md aspect-[4/3] rounded-xl overflow-hidden shadow-lg bg-[#fff2f2] dark:bg-[#1D0002]">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-[#1a237e]/70 to-transparent"></div>
                    </div>
                </div>
            </section>
            ...
            <section id="testimonials" class="mt-24">
                ...
                <div class="grid gap-8 md:grid-cols-3">
                    <div class="bg-white dark:bg-[#161615] rounded-lg shadow-xs p-6 flex flex-col items-center text-center">
                        ...
                        <span class="font-semibold text-[#1a237e] dark:text-[#90caf9]">Sarah M.</span>
                    </div>
                    <div class="bg-white dark:bg-[#161615] rounded-lg shadow-xs p-6 flex flex-col items-center text-center">
                        ...
                        <span class="font-semibold text-[#1a237e] dark:text-[#90caf9]">James L.</span>
                    </div>
                    <div class="bg-white dark:bg-[#161615] rounded-lg shadow-xs p-6 flex flex-col items-center text-center">
