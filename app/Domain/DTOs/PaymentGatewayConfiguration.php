...
class PaymentGatewayConfiguration implements Castable, Wireable
{
    ...
    public static function castUsing(array $arguments)
    {
        ...
        {
            public function get(Model $model, string $key, mixed $value, array $attributes): ?PaymentGatewayConfiguration
            {
